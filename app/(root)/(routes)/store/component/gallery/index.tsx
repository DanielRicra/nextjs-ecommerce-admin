...
const Gallery: React.FC<GalleryProps> = ({ images }) => {
	...
	return (
		<div>
			<div className="mx-auto mt-6 w-full max-w-2xl sm:block lg:max-w-none w-[300px] lg:w-[500px]">
				<Swiper
					style={
						{
					...
					className="w-[300px] lg:w-[500px] aspect-square border rounded-md mb-4 mySwiper2"
				>
					{images.map((image) => (
